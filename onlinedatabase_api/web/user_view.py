...
from onlinedatabase_api.decorators.authorization import authorization
from onlinedatabase_api.providers.user_provider import UserProvider
from onlinedatabase_api.models.user_field import UserFieldSchema
from onlinedatabase_api.models.user_field_category import UserFieldCategorySchema
from onlinedatabase_api.web.user_keycloak import UserKeycloak
...
@onlinedatabase_bp.route('/users/login', methods=['GET'])
@crossdomain(origin='*')
@authentication
def login():
...
@onlinedatabase_bp.route("/users/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
def get_user_count():
...
@onlinedatabase_bp.route("/users", methods=['GET'])
@crossdomain(origin='*')
@authentication
def get_user():
    try:
...
@onlinedatabase_bp.route("/users", methods=['POST'])
@crossdomain(origin='*')
@authentication
def add_user():
    try:
...
@onlinedatabase_bp.route("/users/reset_keycloak_password", methods=['PUT'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/users/demographic_questionnaire", methods=['PUT'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/users", methods=['PUT'])
@crossdomain(origin='*')
@authentication
def update_user():
    try:
...
@onlinedatabase_bp.route("/users", methods=['DELETE'])
@crossdomain(origin='*')
@authentication
def delete_user():
    try:
...
@onlinedatabase_bp.route("/users/export", methods=['GET'])
@crossdomain(origin='*')
@authentication
def export_users():
...
@onlinedatabase_bp.route("users/upload", methods=['POST'])
@crossdomain(origin='*')
@authentication
def import_users():
...
@onlinedatabase_bp.route("/test_taker/demographic_questionnaires", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/admin/user_sessions", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/admin/user_sessions/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
