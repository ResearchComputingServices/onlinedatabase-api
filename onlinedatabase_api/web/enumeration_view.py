...
from onlinedatabase_api.models.enumeration import Enumeration, EnumerationSchema
from onlinedatabase_api.models.enumeration_value import EnumerationValue, EnumerationValueSchema
...
from onlinedatabase_api.providers.view_helper import ViewHelper
from onlinedatabase_api.providers.enumeration_provider import EnumerationProvider
from onlinedatabase_api.extensions import oidc


import pandas as pd
from onlinedatabase_api.providers.raw_sql_provider import RawSqlProvider
...
@onlinedatabase_bp.route("/enumerations/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/enumerations", methods=["GET"])
@crossdomain(origin='*')
@authentication
def get_enumeration():
...
@onlinedatabase_bp.route("/enumerations", methods=['POST'])
@crossdomain(origin='*')
@authentication
def add_enumeration():
    try:
...
@onlinedatabase_bp.route("/enumerations", methods=['PUT'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/enumerations", methods=['DELETE'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/enumerations/export", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/enumerations/upload", methods=['POST'])
@crossdomain(origin='*')
@authentication
