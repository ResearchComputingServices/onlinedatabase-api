...
from onlinedatabase_api.providers.user_field_category_provider import UserFieldCategoryProvider
...
@onlinedatabase_bp.route("/user_field_categories/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
def get_user_field_categories_count():
    return provider.get_count(UserFieldCategory)

@onlinedatabase_bp.route("/user_field_categories", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_categories", methods=['POST'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_categories", methods=['PUT'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_categories", methods=['DELETE'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_categories/export", methods=['GET'])
@crossdomain(origin='*')
@authentication
