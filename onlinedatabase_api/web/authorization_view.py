...
from onlinedatabase_api.models.authorization import Authorization, AuthorizationSchema
...
@onlinedatabase_bp.route("/authorization/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/authorization", methods=['GET'])
@crossdomain(origin='*')
@authentication
@authorization(['read-authorization'])
