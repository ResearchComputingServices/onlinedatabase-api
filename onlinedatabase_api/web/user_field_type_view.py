...
from onlinedatabase_api.providers.user_field_type_provider import UserFieldTypeProvider
import pandas as pd
...
@onlinedatabase_bp.route("/user_field_types/count", methods=['GET'])
@crossdomain(origin='*')
@authentication
def get_user_field_types_count():
    return provider.get_count(UserFieldType)

@onlinedatabase_bp.route("/user_field_types", methods=['GET'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_types", methods=['POST'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_types", methods=['PUT'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_types", methods=['DELETE'])
@crossdomain(origin='*')
@authentication
...
@onlinedatabase_bp.route("/user_field_types/export", methods=['GET'])
@crossdomain(origin='*')
@authentication
